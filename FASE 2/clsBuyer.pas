...
type
  ...
  public
    ...
    procedure SetEcoPoints(iEcoPoints:integer)  ;                                                    //Procedure that receives amount of eco points buyer has and gives the value to eco points attribute of buyer
  end;
...
procedure TBuyer.SetEcoPoints(iEcoPoints: integer);
begin
fEcoPoints:=iEcoPoints;
end;
...
'Method of Payment: ' + #9 +#9+ fPaymentMethod + #13 + 'Registered card/account: '
+ #9 +fPaymentDetails;
end;
